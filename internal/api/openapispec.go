...
type ServerInterface interface {
	...
	GetAgent(w http.ResponseWriter, r *http.Request, agentSymbol string)
	// List Factions
	// (GET /factions)
	GetFactions(w http.ResponseWriter, r *http.Request, params GetFactionsParams)
	// Get Faction
	// (GET /factions/{factionSymbol})
	GetFaction(w http.ResponseWriter, r *http.Request, factionSymbol string)
	// Get Agent
	// (GET /my/agent)
	GetMyAgent(w http.ResponseWriter, r *http.Request)
	// List Contracts
	// (GET /my/contracts)
	GetContracts(w http.ResponseWriter, r *http.Request, params GetContractsParams)
	// Get Contract
	// (GET /my/contracts/{contractId})
	GetContract(w http.ResponseWriter, r *http.Request, contractId string)
	// Accept Contract
	// (POST /my/contracts/{contractId}/accept)
	AcceptContract(w http.ResponseWriter, r *http.Request, contractId string)
	// Deliver Cargo to Contract
	// (POST /my/contracts/{contractId}/deliver)
	DeliverContract(w http.ResponseWriter, r *http.Request, contractId string)
	// Fulfill Contract
	// (POST /my/contracts/{contractId}/fulfill)
	FulfillContract(w http.ResponseWriter, r *http.Request, contractId string)
	// List Ships
	// (GET /my/ships)
	GetMyShips(w http.ResponseWriter, r *http.Request, params GetMyShipsParams)
	// Purchase Ship
	// (POST /my/ships)
	PurchaseShip(w http.ResponseWriter, r *http.Request)
	// Get Ship
	// (GET /my/ships/{shipSymbol})
	GetMyShip(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Get Ship Cargo
	// (GET /my/ships/{shipSymbol}/cargo)
	GetMyShipCargo(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Create Chart
	// (POST /my/ships/{shipSymbol}/chart)
	CreateChart(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Get Ship Cooldown
	// (GET /my/ships/{shipSymbol}/cooldown)
	GetShipCooldown(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Dock Ship
	// (POST /my/ships/{shipSymbol}/dock)
	DockShip(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Extract Resources
	// (POST /my/ships/{shipSymbol}/extract)
	ExtractResources(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Extract Resources with Survey
	// (POST /my/ships/{shipSymbol}/extract/survey)
	ExtractResourcesWithSurvey(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Jettison Cargo
	// (POST /my/ships/{shipSymbol}/jettison)
	Jettison(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Jump Ship
	// (POST /my/ships/{shipSymbol}/jump)
	JumpShip(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Get Mounts
	// (GET /my/ships/{shipSymbol}/mounts)
	GetMounts(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Install Mount
	// (POST /my/ships/{shipSymbol}/mounts/install)
	InstallMount(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Remove Mount
	// (POST /my/ships/{shipSymbol}/mounts/remove)
	RemoveMount(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Get Ship Nav
	// (GET /my/ships/{shipSymbol}/nav)
	GetShipNav(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Patch Ship Nav
	// (PATCH /my/ships/{shipSymbol}/nav)
	PatchShipNav(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Navigate Ship
	// (POST /my/ships/{shipSymbol}/navigate)
	NavigateShip(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Negotiate Contract
	// (POST /my/ships/{shipSymbol}/negotiate/contract)
	NegotiateContract(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Orbit Ship
	// (POST /my/ships/{shipSymbol}/orbit)
	OrbitShip(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Purchase Cargo
	// (POST /my/ships/{shipSymbol}/purchase)
	PurchaseCargo(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Ship Refine
	// (POST /my/ships/{shipSymbol}/refine)
	ShipRefine(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Refuel Ship
	// (POST /my/ships/{shipSymbol}/refuel)
	RefuelShip(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Get Repair Ship
	// (GET /my/ships/{shipSymbol}/repair)
	GetRepairShip(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Repair Ship
	// (POST /my/ships/{shipSymbol}/repair)
	RepairShip(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Scan Ships
	// (POST /my/ships/{shipSymbol}/scan/ships)
	CreateShipShipScan(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Scan Systems
	// (POST /my/ships/{shipSymbol}/scan/systems)
	CreateShipSystemScan(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Scan Waypoints
	// (POST /my/ships/{shipSymbol}/scan/waypoints)
	CreateShipWaypointScan(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Get Scrap Ship
	// (GET /my/ships/{shipSymbol}/scrap)
	GetScrapShip(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Scrap Ship
	// (POST /my/ships/{shipSymbol}/scrap)
	ScrapShip(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Sell Cargo
	// (POST /my/ships/{shipSymbol}/sell)
	SellCargo(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Siphon Resources
	// (POST /my/ships/{shipSymbol}/siphon)
	SiphonResources(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Create Survey
	// (POST /my/ships/{shipSymbol}/survey)
	CreateSurvey(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Transfer Cargo
	// (POST /my/ships/{shipSymbol}/transfer)
	TransferCargo(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Warp Ship
	// (POST /my/ships/{shipSymbol}/warp)
	WarpShip(w http.ResponseWriter, r *http.Request, shipSymbol string)
	// Register New Agent
	// (POST /register)
	Register(w http.ResponseWriter, r *http.Request)
	// List Systems
	// (GET /systems)
	GetSystems(w http.ResponseWriter, r *http.Request, params GetSystemsParams)
	// Get System
	// (GET /systems/{systemSymbol})
	GetSystem(w http.ResponseWriter, r *http.Request, systemSymbol string)
	// List Waypoints in System
	// (GET /systems/{systemSymbol}/waypoints)
	GetSystemWaypoints(w http.ResponseWriter, r *http.Request, systemSymbol string, params GetSystemWaypointsParams)
	// Get Waypoint
	// (GET /systems/{systemSymbol}/waypoints/{waypointSymbol})
	GetWaypoint(w http.ResponseWriter, r *http.Request, systemSymbol string, waypointSymbol string)
	// Get Construction Site
	// (GET /systems/{systemSymbol}/waypoints/{waypointSymbol}/construction)
	GetConstruction(w http.ResponseWriter, r *http.Request, systemSymbol string, waypointSymbol string)
	// Supply Construction Site
	// (POST /systems/{systemSymbol}/waypoints/{waypointSymbol}/construction/supply)
	SupplyConstruction(w http.ResponseWriter, r *http.Request, systemSymbol string, waypointSymbol string)
	// Get Jump Gate
	// (GET /systems/{systemSymbol}/waypoints/{waypointSymbol}/jump-gate)
	GetJumpGate(w http.ResponseWriter, r *http.Request, systemSymbol string, waypointSymbol string)
	// Get Market
	// (GET /systems/{systemSymbol}/waypoints/{waypointSymbol}/market)
	GetMarket(w http.ResponseWriter, r *http.Request, systemSymbol string, waypointSymbol string)
	// Get Shipyard
	// (GET /systems/{systemSymbol}/waypoints/{waypointSymbol}/shipyard)
	GetShipyard(w http.ResponseWriter, r *http.Request, systemSymbol string, waypointSymbol string)
}
...
func (siw *ServerInterfaceWrapper) GetAgent(w http.ResponseWriter, r *http.Request) {
	...
	// ------------- Path parameter "agentSymbol" -------------
	var agentSymbol string

	err = runtime.BindStyledParameterWithOptions("simple", "agentSymbol", r.PathValue("agentSymbol"), &agentSymbol, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "agentSymbol", Err: err})
		return
	}
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetAgent(w, r, agentSymbol)
	}))
...
// GetFactions operation middleware
func (siw *ServerInterfaceWrapper) GetFactions(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetFactions(w, r, params)
	}))
...
// GetFaction operation middleware
func (siw *ServerInterfaceWrapper) GetFaction(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	err = runtime.BindStyledParameterWithOptions("simple", "factionSymbol", r.PathValue("factionSymbol"), &factionSymbol, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "factionSymbol", Err: err})
		return
	}
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetFaction(w, r, factionSymbol)
	}))
...
// GetMyAgent operation middleware
func (siw *ServerInterfaceWrapper) GetMyAgent(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	ctx = context.WithValue(ctx, AgentTokenScopes, []string{})

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetMyAgent(w, r)
	}))
...
// GetContracts operation middleware
func (siw *ServerInterfaceWrapper) GetContracts(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetContracts(w, r, params)
	}))
...
// AcceptContract operation middleware
func (siw *ServerInterfaceWrapper) AcceptContract(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.AcceptContract(w, r, contractId)
	}))
...
// DeliverContract operation middleware
func (siw *ServerInterfaceWrapper) DeliverContract(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.DeliverContract(w, r, contractId)
	}))
...
// FulfillContract operation middleware
func (siw *ServerInterfaceWrapper) FulfillContract(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.FulfillContract(w, r, contractId)
	}))
...
// GetMyShips operation middleware
func (siw *ServerInterfaceWrapper) GetMyShips(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetMyShips(w, r, params)
	}))
...
// PurchaseShip operation middleware
func (siw *ServerInterfaceWrapper) PurchaseShip(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()

	ctx = context.WithValue(ctx, AgentTokenScopes, []string{})

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.PurchaseShip(w, r)
	}))
...
// GetMyShip operation middleware
func (siw *ServerInterfaceWrapper) GetMyShip(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	err = runtime.BindStyledParameterWithOptions("simple", "shipSymbol", r.PathValue("shipSymbol"), &shipSymbol, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "shipSymbol", Err: err})
		return
	}
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetMyShip(w, r, shipSymbol)
	}))
...
// GetMyShipCargo operation middleware
func (siw *ServerInterfaceWrapper) GetMyShipCargo(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetMyShipCargo(w, r, shipSymbol)
	}))
...
func (siw *ServerInterfaceWrapper) CreateChart(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateChart(w, r, shipSymbol)
	}))
...
// GetShipCooldown operation middleware
func (siw *ServerInterfaceWrapper) GetShipCooldown(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetShipCooldown(w, r, shipSymbol)
	}))
...
// DockShip operation middleware
func (siw *ServerInterfaceWrapper) DockShip(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.DockShip(w, r, shipSymbol)
	}))
...
// ExtractResources operation middleware
func (siw *ServerInterfaceWrapper) ExtractResources(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ExtractResources(w, r, shipSymbol)
	}))
...
// ExtractResourcesWithSurvey operation middleware
func (siw *ServerInterfaceWrapper) ExtractResourcesWithSurvey(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ExtractResourcesWithSurvey(w, r, shipSymbol)
	}))
...
// Jettison operation middleware
func (siw *ServerInterfaceWrapper) Jettison(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.Jettison(w, r, shipSymbol)
	}))
...
// JumpShip operation middleware
func (siw *ServerInterfaceWrapper) JumpShip(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.JumpShip(w, r, shipSymbol)
	}))
...
// GetMounts operation middleware
func (siw *ServerInterfaceWrapper) GetMounts(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetMounts(w, r, shipSymbol)
	}))
...
// InstallMount operation middleware
func (siw *ServerInterfaceWrapper) InstallMount(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.InstallMount(w, r, shipSymbol)
	}))
...
// RemoveMount operation middleware
func (siw *ServerInterfaceWrapper) RemoveMount(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.RemoveMount(w, r, shipSymbol)
	}))
...
// GetShipNav operation middleware
func (siw *ServerInterfaceWrapper) GetShipNav(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetShipNav(w, r, shipSymbol)
	}))
...
// PatchShipNav operation middleware
func (siw *ServerInterfaceWrapper) PatchShipNav(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.PatchShipNav(w, r, shipSymbol)
	}))
...
// NavigateShip operation middleware
func (siw *ServerInterfaceWrapper) NavigateShip(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.NavigateShip(w, r, shipSymbol)
	}))
...
// NegotiateContract operation middleware
func (siw *ServerInterfaceWrapper) NegotiateContract(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.NegotiateContract(w, r, shipSymbol)
	}))
...
// OrbitShip operation middleware
func (siw *ServerInterfaceWrapper) OrbitShip(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.OrbitShip(w, r, shipSymbol)
	}))
...
// PurchaseCargo operation middleware
func (siw *ServerInterfaceWrapper) PurchaseCargo(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.PurchaseCargo(w, r, shipSymbol)
	}))
...
// ShipRefine operation middleware
func (siw *ServerInterfaceWrapper) ShipRefine(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ShipRefine(w, r, shipSymbol)
	}))
...
// RefuelShip operation middleware
func (siw *ServerInterfaceWrapper) RefuelShip(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.RefuelShip(w, r, shipSymbol)
	}))
...
// GetRepairShip operation middleware
func (siw *ServerInterfaceWrapper) GetRepairShip(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetRepairShip(w, r, shipSymbol)
	}))
...
// RepairShip operation middleware
func (siw *ServerInterfaceWrapper) RepairShip(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.RepairShip(w, r, shipSymbol)
	}))
...
// CreateShipShipScan operation middleware
func (siw *ServerInterfaceWrapper) CreateShipShipScan(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateShipShipScan(w, r, shipSymbol)
	}))
...
// CreateShipSystemScan operation middleware
func (siw *ServerInterfaceWrapper) CreateShipSystemScan(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateShipSystemScan(w, r, shipSymbol)
	}))
...
// CreateShipWaypointScan operation middleware
func (siw *ServerInterfaceWrapper) CreateShipWaypointScan(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateShipWaypointScan(w, r, shipSymbol)
	}))
...
// GetScrapShip operation middleware
func (siw *ServerInterfaceWrapper) GetScrapShip(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetScrapShip(w, r, shipSymbol)
	}))
...
// ScrapShip operation middleware
func (siw *ServerInterfaceWrapper) ScrapShip(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.ScrapShip(w, r, shipSymbol)
	}))
...
// SellCargo operation middleware
func (siw *ServerInterfaceWrapper) SellCargo(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.SellCargo(w, r, shipSymbol)
	}))
...
// SiphonResources operation middleware
func (siw *ServerInterfaceWrapper) SiphonResources(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.SiphonResources(w, r, shipSymbol)
	}))
...
func (siw *ServerInterfaceWrapper) CreateSurvey(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.CreateSurvey(w, r, shipSymbol)
	}))
...
// TransferCargo operation middleware
func (siw *ServerInterfaceWrapper) TransferCargo(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.TransferCargo(w, r, shipSymbol)
	}))
...
// WarpShip operation middleware
func (siw *ServerInterfaceWrapper) WarpShip(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.WarpShip(w, r, shipSymbol)
	}))
...
func (siw *ServerInterfaceWrapper) GetSystems(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetSystems(w, r, params)
	}))
...
func (siw *ServerInterfaceWrapper) GetSystem(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "systemSymbol", r.PathValue("systemSymbol"), &systemSymbol, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "systemSymbol", Err: err})
		return
	}
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetSystem(w, r, systemSymbol)
	}))
...
// GetSystemWaypoints operation middleware
func (siw *ServerInterfaceWrapper) GetSystemWaypoints(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	// ------------- Optional query parameter "traits" -------------

	err = runtime.BindQueryParameter("form", true, false, "traits", r.URL.Query(), &params.Traits)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "traits", Err: err})
		return
	}

	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetSystemWaypoints(w, r, systemSymbol, params)
	}))
...
// GetWaypoint operation middleware
func (siw *ServerInterfaceWrapper) GetWaypoint(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	err = runtime.BindStyledParameterWithOptions("simple", "waypointSymbol", r.PathValue("waypointSymbol"), &waypointSymbol, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "waypointSymbol", Err: err})
		return
	}
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetWaypoint(w, r, systemSymbol, waypointSymbol)
	}))
...
// GetConstruction operation middleware
func (siw *ServerInterfaceWrapper) GetConstruction(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetConstruction(w, r, systemSymbol, waypointSymbol)
	}))
...
// SupplyConstruction operation middleware
func (siw *ServerInterfaceWrapper) SupplyConstruction(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.SupplyConstruction(w, r, systemSymbol, waypointSymbol)
	}))
...
// GetJumpGate operation middleware
func (siw *ServerInterfaceWrapper) GetJumpGate(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetJumpGate(w, r, systemSymbol, waypointSymbol)
	}))
...
func (siw *ServerInterfaceWrapper) GetMarket(w http.ResponseWriter, r *http.Request) {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetMarket(w, r, systemSymbol, waypointSymbol)
	}))
...
// GetShipyard operation middleware
func (siw *ServerInterfaceWrapper) GetShipyard(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.GetShipyard(w, r, systemSymbol, waypointSymbol)
	}))
...
func HandlerWithOptions(si ServerInterface, options StdHTTPServerOptions) http.Handler {
	...
	m.HandleFunc("GET "+options.BaseURL+"/factions/{factionSymbol}", wrapper.GetFaction)
	m.HandleFunc("GET "+options.BaseURL+"/my/agent", wrapper.GetMyAgent)
	m.HandleFunc("GET "+options.BaseURL+"/my/contracts", wrapper.GetContracts)
	m.HandleFunc("GET "+options.BaseURL+"/my/contracts/{contractId}", wrapper.GetContract)
	m.HandleFunc("POST "+options.BaseURL+"/my/contracts/{contractId}/accept", wrapper.AcceptContract)
	m.HandleFunc("POST "+options.BaseURL+"/my/contracts/{contractId}/deliver", wrapper.DeliverContract)
	m.HandleFunc("POST "+options.BaseURL+"/my/contracts/{contractId}/fulfill", wrapper.FulfillContract)
	m.HandleFunc("GET "+options.BaseURL+"/my/ships", wrapper.GetMyShips)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships", wrapper.PurchaseShip)
	m.HandleFunc("GET "+options.BaseURL+"/my/ships/{shipSymbol}", wrapper.GetMyShip)
	m.HandleFunc("GET "+options.BaseURL+"/my/ships/{shipSymbol}/cargo", wrapper.GetMyShipCargo)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/chart", wrapper.CreateChart)
	m.HandleFunc("GET "+options.BaseURL+"/my/ships/{shipSymbol}/cooldown", wrapper.GetShipCooldown)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/dock", wrapper.DockShip)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/extract", wrapper.ExtractResources)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/extract/survey", wrapper.ExtractResourcesWithSurvey)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/jettison", wrapper.Jettison)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/jump", wrapper.JumpShip)
	m.HandleFunc("GET "+options.BaseURL+"/my/ships/{shipSymbol}/mounts", wrapper.GetMounts)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/mounts/install", wrapper.InstallMount)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/mounts/remove", wrapper.RemoveMount)
	m.HandleFunc("GET "+options.BaseURL+"/my/ships/{shipSymbol}/nav", wrapper.GetShipNav)
	m.HandleFunc("PATCH "+options.BaseURL+"/my/ships/{shipSymbol}/nav", wrapper.PatchShipNav)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/navigate", wrapper.NavigateShip)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/negotiate/contract", wrapper.NegotiateContract)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/orbit", wrapper.OrbitShip)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/purchase", wrapper.PurchaseCargo)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/refine", wrapper.ShipRefine)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/refuel", wrapper.RefuelShip)
	m.HandleFunc("GET "+options.BaseURL+"/my/ships/{shipSymbol}/repair", wrapper.GetRepairShip)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/repair", wrapper.RepairShip)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/scan/ships", wrapper.CreateShipShipScan)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/scan/systems", wrapper.CreateShipSystemScan)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/scan/waypoints", wrapper.CreateShipWaypointScan)
	m.HandleFunc("GET "+options.BaseURL+"/my/ships/{shipSymbol}/scrap", wrapper.GetScrapShip)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/scrap", wrapper.ScrapShip)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/sell", wrapper.SellCargo)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/siphon", wrapper.SiphonResources)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/survey", wrapper.CreateSurvey)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/transfer", wrapper.TransferCargo)
	m.HandleFunc("POST "+options.BaseURL+"/my/ships/{shipSymbol}/warp", wrapper.WarpShip)
	m.HandleFunc("POST "+options.BaseURL+"/register", wrapper.Register)
	m.HandleFunc("GET "+options.BaseURL+"/systems", wrapper.GetSystems)
	m.HandleFunc("GET "+options.BaseURL+"/systems/{systemSymbol}", wrapper.GetSystem)
	m.HandleFunc("GET "+options.BaseURL+"/systems/{systemSymbol}/waypoints", wrapper.GetSystemWaypoints)
	m.HandleFunc("GET "+options.BaseURL+"/systems/{systemSymbol}/waypoints/{waypointSymbol}", wrapper.GetWaypoint)
	m.HandleFunc("GET "+options.BaseURL+"/systems/{systemSymbol}/waypoints/{waypointSymbol}/construction", wrapper.GetConstruction)
	m.HandleFunc("POST "+options.BaseURL+"/systems/{systemSymbol}/waypoints/{waypointSymbol}/construction/supply", wrapper.SupplyConstruction)
	m.HandleFunc("GET "+options.BaseURL+"/systems/{systemSymbol}/waypoints/{waypointSymbol}/jump-gate", wrapper.GetJumpGate)
	m.HandleFunc("GET "+options.BaseURL+"/systems/{systemSymbol}/waypoints/{waypointSymbol}/market", wrapper.GetMarket)
	m.HandleFunc("GET "+options.BaseURL+"/systems/{systemSymbol}/waypoints/{waypointSymbol}/shipyard", wrapper.GetShipyard)
